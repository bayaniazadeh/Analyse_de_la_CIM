...
data <- read.csv("/Users/azadehbayani/Documents/Azadé/UdeM/Master/Projet/Regression/code/icd10_ELix.csv")

full.model <- glm(death ~ Chf + Carit+Valv+Pcd+Pvd+Hypunc+Hypc+Para+
Ond+Cpd+Diabunc+Diabc+Hypohthy+Rf+Ld+Pud+Aids+
Lymph+Metacanc+Solidtum+Rheumd+Coag+Obes+Wloss+Fed+Blane+
