...
data <- read.csv("/Users/azadehbayani/Documents/Azadé/UdeM/Master/Projet/Regression/code/icd9_CCI.csv")

full.model <- glm(death ~ Mi+Chf+Pvd+Cevd+Cpd+Rheumd+Mld+Hp+
                          Rend+Canc+Msld+Aids,
